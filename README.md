...
* Предполагаемые организационные требования:
  ...
  + Нужно, чтобы кто-то занимался этим
    - Я хотела бы помочь этому проекту вначале, 
* Предполагаемые расходы:
  ...
  + Я не знаю, где взять эти деньги на первое время
    - Может быть можно начать с того, что найи 1-2 довольно крупных заказа на ремонт квартиры без страховки и вообще безо всяких расходов, и с этих денег начать всё остальное
