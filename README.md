...
* **Предполагаемые риски**:
  ...
  + Тот факт, что юрлицо не получает никакой прибыли, является в некоторой степени защитой на случай разбирательств: возможно можно будет добиться списания штрафов
  + Возможно, если это будет оформлено на ассоциацию (в не на фирму), также несколько защитит от штрафов
