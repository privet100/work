...
* **Преимущества для работника**:
  ...
  + Всю прибыль от заказа получает сам работник
    ...
    - Этот факт является в некоторой степени защитой на случай разбирательств: если фирма сама не получает никакой выгоды, возможно можно будет добиться списания штрафов
